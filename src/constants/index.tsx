...
export const TOGGLE_PHOTO_BROWSE_INFO = 'TOGGLE_PHOTO_BROWSE_INFO';
export type TOGGLE_PHOTO_BROWSE_INFO = typeof TOGGLE_PHOTO_BROWSE_INFO;

export const OPEN_PHOTO_BROWSE_INFO = 'OPEN_PHOTO_BROWSE_INFO';
...
export const SET_VIDEO_BUFFERS = 'SET_VIDEO_BUFFERS';
